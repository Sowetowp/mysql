...
function insertRowIntoTable(data) {
    ...
    tableHtml += `
        <td class="py-3 edit-row-btn px-3 text-xs" data-id=${data.id} data-id="1" data-name="John Doe" data-date-added="2024-01-01T12:00:00Z" data-comment="This is a comment">
